...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="{{ route('app.home') }}">news</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('app.all') }}">local news</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('app.all') }}">International news</a>
                </li>  <li class="nav-item">
                    <a class="nav-link" href="{{ route('app.all') }}">sport news</a>
                </li>
                <li class="nav-item">
